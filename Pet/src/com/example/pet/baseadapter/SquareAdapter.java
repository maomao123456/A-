...
public class SquareAdapter extends BaseAdapter {
	...
	public SquareAdapter(Context context, List<SquareListview> list, int item,
			int[] id) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		 ...
		 * 
		 * @Override public void onClick(View v) {//对关注按钮的监听 // TODO
		 * Auto-generated method stub switch(position){ case 0:
		 * Toast.makeText(context, "0000", Toast.LENGTH_SHORT).show();
		 * guanzhu(); break; case 1: Toast.makeText(context, "2222",
		 * Toast.LENGTH_SHORT).show(); guanzhu(); break; } } });
		 */
		return convertView;
	}
	/**
	 ...
	 */
	/*
	 * public void guanzhu(){ if(guanzhu.getText().toString().equals("+关注")){
	 * guanzhu.setText("已关注"); }else{ AlertDialog alertDialog; Builder builder;
	 * builder=new AlertDialog.Builder(context);
	 * builder.setMessage("你真的要取消对我的关注吗？"); builder.setPositiveButton("是的",
	 * onClickListener); builder.setNegativeButton("我再想想", onClickListener);
	 ...
	 * Auto-generated method stub switch(arg1){ case -1: guanzhu.setText("+关注");
	 * Toast.makeText(context, "已取消关注", Toast.LENGTH_SHORT).show(); break; case
	 * -2: break; } } };
	 */
}
